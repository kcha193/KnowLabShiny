...
dbHeader <- dashboardHeader(title = "Knowledge Lab",
                            tags$li(a(href = 'http://www.arts.auckland.ac.nz/content/dam/uoa/arts/research-centres/compass/documents/bcaso-technical-report.pdf',
                          ...
                          fluidRow(
                            box(title ="Variable", width = 3,
                                ...
                                bsPopover("actionAddSBUI", "",
                                          ...
                                          placement ="right", options = list(container = "body")),
                                selectInput("nRun",HTML("<b> <font size=\"4\">STEP 6 (optional): </font></b> Choose number of Runs:"), c(1:10), selected = 10),
                                bsPopover("nRun", "",
